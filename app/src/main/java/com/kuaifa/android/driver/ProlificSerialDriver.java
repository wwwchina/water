...
package com.kuaifa.android.driver;
...
public class ProlificSerialDriver implements UsbSerialDriver {
    ...
    class ProlificSerialPort extends CommonUsbSerialPort {
        ...
        private final void outControlTransfer(int requestType, int request,int value, int index, byte[] data) throws IOException {
            int length = (data == null) ? 0 : data.length; //7
            //controlTransfer 参数 一个命令格式 bmRequestType + bRequest + wValue + wIndex + wLiength
            //bmRequest 代表方向 主机到设备 或者 设备到主机
            //bRequest 命令
            //wValue 参数1
            //wIndex 参数2
        ...
        public void open(UsbDeviceConnection connection) throws IOException {
            ...
            //具有数据传输功能的接口 USBInterface 一个isbDevice 有多个USBInterface ，我们需要的一般是第一个
